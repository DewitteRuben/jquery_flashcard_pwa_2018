...
!function (t) {
    ...
    function n(n, s) {
        ...
        var o, a = n, r = 0;
        if (A(n)) a = R.test(n) ? O.getElementById(n.slice(1)) : P.test(n) ? e(n) : t(n, s); else if (I(n)) return i(n), this;
        if (!a) return this;
        if (a.nodeType || a === T) this[0] = a, this.length = 1; else for (o = this.length = a.length; r < o; r++) this[r] = a[r];
        return this
    }
    ...
    var x, O = document, T = window, L = Array.prototype, $ = L.slice, B = L.filter, D = L.push, S = function () {
        }, I = function (t) {
    ...
    return j.extend({
        position: function () {
            ...
            return {top: t.top + T.pageYOffset - V.clientTop, left: t.left + T.pageXOffset - V.clientLeft}
...
document.addEventListener("keydown", docHandleKeydown), document.addEventListener("keyup", docHandleKeyup), M.initializeJqueryWrapper = function (t, e, i) {
    ...
    var n = {top: !1, right: !1, bottom: !1, left: !1}, s = t.getBoundingClientRect(), o = t.scrollLeft,
        a = t.scrollTop, r = e.left - o, l = e.top - a;
...
!function (t) {
    ...
    function T(t, e) {
        ...
        return t.tweens.map(function (n) {
            var s = (n = x(n, e)).value, o = m(e.target, t.name), a = i ? i.to.original : o, a = H.arr(s) ? s[0] : a,
        ...
        return _inherits(n, Component), _createClass(n, [{
            ...
            key: "_calculatePositioning", value: function () {
                ...
                var s = this.$origin.outerWidth(), o = this.$origin.outerHeight(),
                    ...
                    x = c && !m ? g / 2 - s : 0, O = s, T = f ? "bottom" : "top", L = 2 * s, $ = L, B = _ / 2 - $ / 2,
                    D = g / 2 - L / 2, S = {};
                S.top = v ? y + "px" : "", S.right = p ? l - k - g + "px" : "", S.bottom = f ? h - y - _ + "px" : "", S.left = c ? k + "px" : "", S.position = b, t(this.wrapper).css(S), t(this.contentEl).css({
                    ...
                    padding: O + "px",
                    verticalAlign: T
                }), t(this.waveEl).css({top: B + "px", left: D + "px", width: L + "px", height: $ + "px"})
            }
        }, {
            key: "open", value: function () {
    ...
    var i = {}, n = function (n) {
        ...
        return _inherits(s, Component), _createClass(s, [{
            ...
            key: "_calcRangeOffset", value: function () {
                var t = this.$el.width() - 15, e = parseFloat(this.$el.attr("max")),
